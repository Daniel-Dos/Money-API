 ...
 * 
 * <br>
 * <h2>cotação a partir de uma data especifica</h2>
 * 
 * Com o moneta é possivel realizar uma busca a partir de uma data especifica
 * para isso é utilizado a classe {@code ConversionQuery} com ela é possivel realizar
 * buscas de datas diferentes ou num range de datas. A representação pe a classe {@code LocalDate}
 *
 */
